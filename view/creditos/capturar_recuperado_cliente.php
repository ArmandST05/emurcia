...
$factura = $modelCredito->seleccionarfactura($idCliente, $idFac);

if (empty($cliente) || empty($factura)) {
  echo "<script> 
          alertify.error('Los datos proporcionados son incorrectos');
          window.location.href = 'index.php?action=creditos/buscar_recuperado_cliente.php';
        </script>";
} else {
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  <div class="inline-block">
    ...
    <a href="index.php?action=creditos/buscar_recuperado_cliente.php">Capturar crédito recuperado</a> /
...
<div class="row">
  <div class="col-xl-12 col-lg-12">
    <div class="card shadow mb-4">
      <!-- Card Body -->
      <form action="../controller/Creditos/InsertarCreditoRecuperado.php" method="POST" name="form1">
        <div class="card-body">
          <div class="row">
            <div class="col-md-8">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <input class="form-control form-control-sm" type="text" name="nota" id="nota" value="<?php echo $factura["num_factura"] ?>">
                </div>
              </div>
              <div class="row">
                <div class="col-md-2">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <label>*PENDIENTE POR PAGAR: $ <?php echo $restoPagar; ?> | El importe de esta factura es: $<?php echo $factura["importe"] ?></font></label>
                </div>
              </div>
              <div class="row">
                <div class="col-md-2">
            ...
            <div class="col-md-4">
              <div class="card border-light mb-3" style="max-width: 18rem;">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <h6><b>$<?php echo $cliente["credit_actual"]; ?></b></h6>
                  </div>
                  <div class="row">
                    <h6>Límite de crédito</h6>
                  </div>
                  <div class="row">
                    <h6><b>$<?php echo $cliente["credit_otor"]; ?></b></h6>
                  </div>
                </div>
              </div>
            </div>
