      ...
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-6">
            ...
            <form action="index.php?action=reportes/relacion_inicial_mes.php" method="post">
              <div class="row">
                <div class="col-md-6">
      ...
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-6">
            ...
            <form action="index.php?action=reportes/relacion_dia.php" method="POST">
              <div class="row">
                <div class="col-md-4">
      ...
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-6">
            ...
            <form action="index.php?action=reportes/relacion_fin_mes.php" method="POST">
              <?php if ($_SESSION['tipoUsuario'] == "su" || $_SESSION["tipoUsuario"] == "uc") : ?>
                <div class="row">
                  <div class="col-md-12">
                    <select class="form-control form-control-sm" name="zona">
      ...
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-12">
            ...
            <form action="index.php?action=reportes/relacion_saldos_cliente.php" method="POST">
              <div class="row">
      ...
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-6">
            ...
            <label>Seleccione un cliente:</label>
            <form action="index.php?action=reportes/relacion_inicial_mes_cliente.php" method="POST">
              <div class="row">
...
<script type="text/JavaScript">
  $('#clienteSaldos').select2({
    ...
    ajax: {
      url: '../controller/Clientes/BuscarClientesGasNombre.php',
      type: 'GET',
      dataType: 'json',
      delay: 250,
