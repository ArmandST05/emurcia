...
$creditos = $modelCredito->obtenerCreditosGasOtorgadosCliente('cliente',$idCliente);
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-10">
                            <div class="info">
                                <table>
                                    <tr><strong><label><?php echo "Total otorgados: $" . number_format($importe,2) ?></label></strong></tr><br>
                                    <tr><strong><label><?php echo "Abonos: $" . number_format($importe_pag,2) ?></label></strong></tr><br>
                                    <tr><strong><label><?php echo "Saldo: $" . number_format($saldo,2) ?></label></strong></tr>
                                </table>
                            </div>
                        </div>
                        <div clas="col-md-2">
