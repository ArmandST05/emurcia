...
class tc_calendar{
	...
	function getDayHeaders(){
		$rtn_hdrs = array();
		$hdrs = array("0"=>"Dom", "1"=>"Lun", "2"=>"Mar", "3"=>"Mie", "4"=>"Jue", "5"=>"Vie", "6"=>"Sab");
	...
	function writeDay(){
		...
		echo("<option value=\"00\"".($this->rtl ? " dir=\"rtl\"" : "").">Dia</option>");
	...
	function writeMonth(){
		...
		echo("<option value=\"00\"".($this->rtl ? " dir=\"rtl\"" : "").">Mes</option>");
	...
	function writeYear(){
		...
		echo("<option value=\"0000\"".($this->rtl ? " dir=\"rtl\"" : "").">Año</option>");
