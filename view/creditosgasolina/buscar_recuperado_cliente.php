...
if ($_SESSION['tipoUsuario']!="su" && $tipoZona != 2) {
  echo "<script> 
...
if (!empty($valor)) {
  $creditos = $modelCredito->obtenerCreditosGasolinaOtorgadosCliente($tipoBusqueda, $valor);
    ...
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-md-2">
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="tipoBusqueda" id="tipoBusqueda" value="factura" disabled>
  ...
  <div class="row">
    <div class="col-xl-12 col-lg-12">
      <div class="card shadow mb-4">
        <!-- Card Header - Dropdown -->
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          <h6 class="m-0 font-weight-bold text-primary">Créditos otorgados <?php (!empty($cliente)) ? $cliente["nombre_cliente"] : "" ?></h6>
        </div>
        <!-- Card Body -->
        <div class="card-body">
          ...
          <div id="dvData">
            <table id="datosexcel">
              <tr><b><label><?php echo "Total otorgados: $" . $importe ?></label></b></tr><br>
              <tr><b><label><?php echo "Abonos: $" . $importe_pag ?></label></b></tr><br>
              <tr><b><label><?php echo "Saldo: $" . $saldo ?></label></b></tr>
            </table>
            <table id="datosexcel" class="table table-striped table-bordered table-sm table-responsive" style="width:100%">
              ...
              <tbody>
                <?php
                foreach ($creditos as $credito) :
                  $pendientePagar = $credito["importe"] - $credito["importe_pagado"];
                ?>
                  <tr>
...
<script type="text/JavaScript">
  ...
  $('#selectCliente').select2({
    ...
    ajax: {
      url: function () {
        if($("#tipoBusqueda").val() == "factura"){
          return '../controller/Clientes/BuscarClientesFactura.php';
        }
        else{
          return '../controller/Clientes/BuscarClientesNombre.php';
        }     
      },
      type: 'GET',
      dataType: 'json',
  ...
  function obtenerDatosCredito(){
    ...
    if(combo.selectedIndex<0){
     ...
     window.location.href = 'index.php?action=creditosgasolina/buscar_recuperado_cliente.php&valor='+valor;
    }
  }

  function recuperarCredito(idCliente,numFactura){
     window.location.href = 'index.php?action=creditosgasolina/capturar_recuperado_cliente.php&cliente='+idCliente+'&numFactura='+numFactura;
  }
</script>